        ...
        if ($table == 'tx_azuresearch_index') {
            if ($status == 'new') {
                ...
                $index->addField(new Index\Field('uid', Index\Field::TYPE_STRING, true, false))
                    ...
                    ->addField(new Index\Field('ctype', Index\Field::TYPE_STRING, false, false, true, false, false))
                    ->addField(new Index\Field('categories', Index\Field::TYPE_INT32, false, false, true, false, false))
                    ...
                    ->addField(new Index\Field('sys_language_uid', Index\Field::TYPE_INT32, false, false, true, false, false))
